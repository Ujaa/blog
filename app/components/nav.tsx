...
export function Navbar() {
  ...
  return (
    <aside className="mb-16 px-4 xl:px-0 mx-auto py-3 w-full tracking-tight flex justify-between items-center sticky top-0 bg-white/70 dark:bg-neutral-900/70 backdrop-blur-lg border-b border-b-neutral-100 dark:border-b-neutral-100/10 z-40">
